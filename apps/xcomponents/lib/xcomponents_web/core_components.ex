defmodule XcomponentsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(XdemoBaseWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(XdemoBaseWeb.Gettext, "errors", msg, opts)
    # end
