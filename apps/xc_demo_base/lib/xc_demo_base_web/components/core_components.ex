defmodule XcDemoBaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(XcDemoBaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(XcDemoBaseWeb.Gettext, "errors", msg, opts)
    end
  end
