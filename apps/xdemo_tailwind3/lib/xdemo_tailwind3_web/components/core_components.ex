defmodule XdemoTailwind3Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(XdemoTailwind3Web.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(XdemoTailwind3Web.Gettext, "errors", msg, opts)
    # end
