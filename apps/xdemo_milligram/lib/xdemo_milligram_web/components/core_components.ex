defmodule XdemoMilligramWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(XdemoMilligramWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(XdemoMilligramWeb.Gettext, "errors", msg, opts)
    # end
